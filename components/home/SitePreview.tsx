...
export function SitePreview() {
  return (
    <div
      aria-hidden
      className="relative aspect-[4/3] w-full overflow-hidden rounded-lg border border-node-line bg-node"
    >
      {/* browser chrome */}
      <div className="flex items-center gap-1.5 border-b border-node-line bg-surface-2 px-3 py-2">
        <span className="h-1.5 w-1.5 rounded-full bg-node-line" />
        <span className="h-1.5 w-1.5 rounded-full bg-node-line" />
        <span className="h-1.5 w-1.5 rounded-full bg-node-line" />
        <span className="ml-2 h-2 w-20 rounded-full bg-node-line" />
      </div>
      ...
      <div className="bv-scroll flex flex-col gap-2.5 p-3">
        ...
        />
        <div className="h-2 w-3/4 rounded-full bg-node-line" />
        <div className="h-2 w-1/2 rounded-full bg-node-line" />
        ...
        <div className="mt-1 h-2 w-2/3 rounded-full bg-node-line" />
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-10 bg-gradient-to-t from-node to-transparent" />
    </div>
  );
}
